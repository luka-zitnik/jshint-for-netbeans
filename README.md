...
Creates Action Items and Annotations out of [JSHint](http://jshint.com/) errors.
...
Looks up configuration files the same way [JSHint for npm](https://www.npmjs.com/package/jshint) does, by running recursive searches from the directory of the actual JS file and up to the filesystem root.
